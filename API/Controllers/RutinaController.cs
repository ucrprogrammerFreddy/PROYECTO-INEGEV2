...
namespace PowerVital.Controllers
{
    ...
    public class RutinaController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<RutinaDTO>>> GetRutinas()
        {
            ...
            //        FechaFin = r.FechaFin,
            //        ClienteIdUsuario = r.ClienteIdUsuario
        ...
        .Include(r => r.EjerciciosRutina) // ✅ Traer ejercicios relacionados
        .Select(r => new RutinaDTO
        {
            IdRutina = r.IdRutina,
            FechaInicio = r.FechaInicio,
        ...
        public async Task<ActionResult<RutinaDTO>> GetRutina(int id)
        {
            ...
            return new RutinaDTO
            {
                ...
                ClienteIdUsuario = rutina.ClienteIdUsuario
            };
        }

        // POST: api/Rutina
        [HttpPost("crearRutina")]
        public async Task<ActionResult<Rutina>> PostRutina(RutinaDTO dto)
        {
            var rutina = new Rutina
            {
                FechaInicio = dto.FechaInicio,
                FechaFin = dto.FechaFin,
                ClienteIdUsuario = dto.ClienteIdUsuario
                // Assuming IdRutina is auto-generated by the database
        ...
        public async Task<IActionResult> PutRutina(int id, RutinaDTO dto)
        {
            ...
            rutina.ClienteIdUsuario = dto.ClienteIdUsuario;
