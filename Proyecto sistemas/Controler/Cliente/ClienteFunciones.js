...
document.addEventListener("DOMContentLoaded", () => {
  ...
  switch (vista) {
    ...
    default:
      console.warn(
        "⚠️ Vista desconocida. No se ejecutó ningún comportamiento."
      );
  }
});
...
function mostrarDatosPersonales(cliente) {
  ...
  document.getElementById("fechaNacimiento").textContent = formatearFecha(
...
function mostrarPadecimientos(padecimientos) {
  const texto =
    padecimientos && padecimientos.length > 0
